...
def analyze_commit_classification(end_date=None, suffix=""):
    ...
    input_file = os.path.join(base_dir, '..', 'results', 'results_v6.csv')
    output_txt = os.path.join(base_dir, '..', 'results', f'RQ3_results{suffix}.txt')
    # output_pdf_h = os.path.join(base_dir, '..', 'results', f'RQ3_pieCharts_horizontal{suffix}.pdf')
    # output_pdf_v = os.path.join(base_dir, '..', 'results', f'RQ3_pieCharts_vertical{suffix}.pdf')
...
if __name__ == "__main__":
    # 2つの期間で分析を実行
    # 1. 2025/09/22まで
    analyze_commit_classification(end_date="2025-09-22", suffix="_until_0922")
    
    # 2. 2025/10/22まで
    analyze_commit_classification(end_date="2025-10-22", suffix="_until_1022")
